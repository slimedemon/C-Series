...
using DemoClientApplication.BulkImport;
using DemoClientApplication.Models;
using DemoClientApplication.BulkImport;

namespace DemoClientApplication.DataOperations
{
    public class InventoryDAL
    {
        ...
        public InventoryDAL()
        {
            _connectionString = @"data source =.\SQLEXPRESS; initial catalog = AutoLot; integrated security = True";
        }
